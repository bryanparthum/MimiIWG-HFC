...
data <- read_csv(paste0("../data/hfc",hfc,".csv")) %>% 
                 filter(geography=="Domestic" & discount_rate %in% discount_rates) %>% 
                 select(!geography)
...
write_excel_csv(annual_w, "../data/schfc_annual_2020_dollars_domestic.csv")
write_excel_csv(five_year_w, "../data/schfc_five_year_2020_dollars_domestic.csv")
